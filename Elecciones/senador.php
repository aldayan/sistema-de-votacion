...
if(isset($_GET['id'])){
  ...
  $message = "Su voto a sido registrado con exito";
...
<?php endif; ?>
      ...
      <section class="text-center">
        <div class="container">
          <h1 class="jumbotron-heading">Senador</h1>
        </div>
      </section>
      ...
      <div class="album py-5 bg-light">
        ...
        <div class="container">
          ...
          <?php foreach($listCA as $Puestos) :?>
            ...
            <?php if($utilities->StatusS($Puestos->id,"../database")==true): ?>
         ...
         <img class="card-img-top" src="<?php echo "../img/candidatos/" . $Puestos->foto; ?>" width="100px" height="200px">
          ...
          <?php endif; ?>
                <div class="card-body">
                  ...
                  <a href="senador.php?id=<?php echo $Puestos->id;?>" class="btn btn-lg btn-block btn-primary">Votar</a>
                </div>
              </div>
            </div>
         <?php else: ?>
