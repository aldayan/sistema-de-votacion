      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <?php foreach($listCA as $Puestos) :?>
            <tr>
            <td>
         <?php if($Puestos->logo == "" || $Puestos->logo == null): ?>

         <img  src="<?php echo "../img/default.png" ?>" width="100px" height="100px">

         <?php else: ?>

         <img  src="<?php echo "../img/partidos/" . $Puestos->logo; ?>" width="100px" height="100px">
          ...
          <?php endif; ?>
              ...
              <?php if($service1->VerificarElec()!=false): ?>
                <div></div>
                <?php else:?>
              <a href="PartidoEdit.php?id=<?php echo $Puestos->id;?>" class="btn btn-outline-warning">Editar</a>
                <a onclick="preguntar(<?php echo $Puestos->id; ?>)"   class="btn btn-outline-danger">Borrar</a>
                <a href="PartidosAc.php?id=<?php echo $Puestos->id;?>" class="btn btn-outline-warning">Activar</a>
                <?php endif; ?>
              </td>
            </tr>
            <?php endforeach ;?>
        ...
        <a href="PartidoAdd.php" type="submit" class="btn btn-primary btn-lg btn-block">Agregar partido</a>
      </div>
    </main>
  </div>
</div>
...
function preguntar(id) {
  if(confirm('¿Esta seguro que desea desactivar este partido?')){
    window.location.href="PartidosDes.php?id="+id;
  }
}
